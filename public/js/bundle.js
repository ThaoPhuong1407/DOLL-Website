...
var displayMap = function displayMap(loc) {
  ...
  bounds.extend([-71.2280607, 42.4454253]);
  bounds.extend([-71.2287756, 42.4451581]); // Add popup

  new mapboxgl.Popup({
    offset: 10
  }).setLngLat(loc).setHTML("<p> 114 Waltham St, Lexington, MA 02421 </p>").addTo(map); // Create a nice transition/animation
...
exports.deleteCurrentData = exports.updateCurrentData = exports.createNew = exports.filterText = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert("Added New ".concat(type.toUpperCase(), " Successfully"));
              window.setTimeout(function () {
                location.assign("/".concat(loadPage));
              }, 1000);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert("Update ".concat(type.toUpperCase(), " Successfully"));
              window.setTimeout(function () {
                location.assign("/".concat(loadPage));
              }, 1000);
            }
...
exports.updateCurrentData = updateCurrentData;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              alert("Delete ".concat(type.toUpperCase(), " Successfully")); // location.reload(true);
...
exports.deleteCurrentData = deleteCurrentData;
...
var btnText = document.getElementById("show"); // VALUES 

var loc = [-71.2280607, 42.4454253]; // Login
...
if (inputForm) {
  ...
  inputForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var elemId, data, type, loadPage, name, startDate, endDate, shortDescription, body, icon, title, author, source, dateCreated, _body, _title, _dateCreated, _body2, _name, _shortDescription, image, longDescription, _name2, jobTitle, _image, description;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              body = _context.sent;
              body = (0, _submit.filterText)(body, 'paragraph');
              ...
              if (document.querySelector('.slug')) {
                loadPage = "project/".concat(document.querySelector('.slug').id);
              } else {
            ...
            case 30:
              _body = _context.sent;
              _body = (0, _submit.filterText)(_body, 'paragraph');
              if (title !== '') data.title = title;
              if (author !== '') data.author = author;
              if (source !== '') data.source = source;
              if (dateCreated !== '') data.dateCreated = dateCreated;
              if (_body !== '') data.body = _body;
              type = 'post';

              if (document.querySelector('.slug')) {
                loadPage = "post/".concat(document.querySelector('.slug').id);
              } else {
                loadPage = 'newsandprojects';
              }
            ...
            case 41:
              ...
              _dateCreated = document.getElementById('dateCreated').value;
              _context.next = 46;
              return tinyMCE.activeEditor.getContent();

            case 46:
              _body2 = _context.sent;
              _body2 = (0, _submit.filterText)(_body2, 'paragraph');
              if (_title !== '') data.title = _title;
              if (_body2 !== '') data.body = _body2;
              if (_dateCreated !== '') data.dateCreated = _dateCreated;
              type = 'update';
            ...
            case 55:
              if (!(elemId[0] === 'solution')) {
                _context.next = 71;
                break;
              }

              _name = document.getElementById('name').value.trim();
              _shortDescription = document.getElementById('shortDescription').value.trim();
              image = document.getElementById('image').value.trim();
              _context.next = 61;
              return tinyMCE.activeEditor.getContent();

            case 61:
              longDescription = _context.sent;
              longDescription = (0, _submit.filterText)(longDescription, '');
              if (_name !== '') data.name = _name;
              if (_shortDescription !== '') data.shortDescription = _shortDescription;
              if (longDescription !== '') data.longDescription = longDescription;
              if (image !== '') data.image = image;
              type = 'solution';

              if (document.querySelector('.objID')) {
                loadPage = "#popup-".concat(document.querySelector('.objID').id);
              } else {
                loadPage = '';
              }
            ...
            case 71:
              if (!(elemId[0] === 'employee')) {
                _context.next = 85;
                break;
              }

              _name2 = document.getElementById('name').value.trim();
              jobTitle = document.getElementById('jobTitle').value.trim();
              _image = document.getElementById('image').value.trim();
              _context.next = 77;
              return tinyMCE.activeEditor.getContent();

            case 77:
              description = _context.sent;
              description = (0, _submit.filterText)(description, 'paragraph');
              if (_name2 !== '') data.name = _name2;
              if (jobTitle !== '') data.jobTitle = jobTitle;
              if (description !== '') data.description = description;
              if (_image !== '') data.image = _image;
              type = 'person';
              loadPage = 'about';

            case 85:
              if (elemId[2]) {
                (0, _submit.updateCurrentData)(type, data, loadPage, elemId[2]);
              } else {
                (0, _submit.createNew)(type, data, loadPage);
              }
...
if (deleteData) {
  var _loop = function _loop(i) {
    ...
    document.getElementById(elemId).addEventListener('click', function (event) {
      ...
      var type = elemIdArray[0];
      var id = elemIdArray[2];
      (0, _submit.deleteCurrentData)(type, id);
    });
  };
